...
export const useSelectProducts = (selectedProducts: ISelectedProduct[], setSelectedProducts: Dispatch<React.SetStateAction<ISelectedProduct[]>>) => {
	...
	const [values, setValues] = useState<IOption[]>([])
		...
		}, [isPending, selectedProducts, options, values])
}